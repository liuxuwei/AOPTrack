...
object FragmentPageTrack {
    private const val TAG = "FragmentPageTrack"
    ...
    fun trackOnHiddenChange(joinPoint: JoinPoint, isHidden: Boolean) {
        Log.d(TAG, "trackOnHiddenChange: $currentPageName $isHidden")
    }
    ...
    fun getPagePath(joinPoint: JoinPoint): String {
